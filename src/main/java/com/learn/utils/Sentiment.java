...
//情感分类训练
//https://blog.csdn.net/wustzbq0713/article/details/46004875
public class Sentiment {
    ...
    public void Model( ) throws Exception {
        ...
        this.Sentiment_Doc_Weight("D:\\bs\\sjwlqg\\src\\main\\resources\\500trainblogxml\\");//先对这个东西进行训练，让他知道哪些词语是啥意思，然后使用了很多词语和语句进行建模训练。
        //这个训练的数据就来源这些XML文件然后训练好了，真正用的时候，是不需要使用哪个xml文件的
